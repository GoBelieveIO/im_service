...
im:im.go client.go route.go app_route.go protocol.go  group_manager.go group.go set.go config.go monitoring.go sio.go storage_client.go channel.go storage_message.go route_message.go user.go reload.go rpc.go
	go build im.go client.go route.go app_route.go protocol.go group_manager.go group.go set.go config.go monitoring.go sio.go storage_client.go channel.go storage_message.go route_message.go user.go reload.go rpc.go

ims:storage_server.go protocol.go storage.go config.go storage_message.go storage_sync.go group_manager.go group.go set.go comparer.go
	go build -o ims storage_server.go protocol.go storage.go config.go storage_message.go storage_sync.go group_manager.go group.go set.go comparer.go
...
main.test:storage_test.go storage.go protocol.go storage_message.go storage_sync.go comparer.go
	go test -c  storage.go storage_test.go protocol.go storage_message.go storage_sync.go comparer.go
